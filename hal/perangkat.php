...
if(isset($_POST['tambah'])){
  ...
  $sql = "INSERT INTO devices1 (serialnumber) VALUES ('$serialnumber')";
  mysqli_query($db, $sql);
}
...
if(isset($_GET['del'])){
  ...
  $sql = "DELETE FROM devices1 WHERE serialnumber = '$serialnumber'";
  mysqli_query($db, $sql);
}

$sql = "SELECT * FROM devices1";
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="?p=perangkat&del=<?php echo $row['serialnumber']?>">Hapus</a></td>
                  </tr>
